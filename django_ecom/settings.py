...
# here 1st one is disabled because user can set password like username, username is only for our advantages,
...
# this is for external package where we use bangladeshi number only
PHONENUMBER_DB_FORMAT = 'NATIONAL'
PHONENUMBER_DEFAULT_REGION = 'BD'

# this is from django allauth, important for communicate with user model
