...
urlpatterns = [
    ...
    path('product-with-quantity/<uuid:pk>/', views.ProductWithQuantityUpdateDestroy.as_view()),
    path('my-bags/', views.MyBagListCreate.as_view()),
    path('my-bag/<uuid:pk>/', views.MyBagUpdate.as_view()),
    path('my-orders/', views.MyOrderListCreate.as_view()),
    path('my-canceled-orders/', views.MyCanceledOrderList.as_view()),
    path('my-order/<uuid:pk>/', views.MyOrderRetrieveUpdate.as_view()),
